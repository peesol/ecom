...
Route::get('/admin/orders_history', 'Admin\AdminController@index');
...
Route::get('/api/get/order_month', 'Api\GetterController@getThisMonthOrder');
Route::get('/api/get/order_history', 'Api\GetterController@getOrderHistory');
